...
contract MockOracle is ChainlinkRequestInterface, LinkTokenReceiver {
   ...
   * @param _proof The oracle answer
    ...
    returns (bool)
  {
    ...
    (bool success, ) = req.callbackAddr.call(abi.encodeWithSelector(req.callbackFunctionId, _requestId, _proof)); // solhint-disable-line avoid-low-level-calls
    return success;
  }
